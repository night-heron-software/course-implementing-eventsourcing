import {
    ...
    subscribeStream,
    unsubscribeStream,
} from '@/app/infrastructure/inmemoryEventstore';
 ...
 */
    ...
    useEffect(() => {
        let subscription = subscribeStream(
            Streams.Cart,
            (_nextExpectedStreamVersion, events: CartEvents[]) => {
    ...
    return (
        <div className="box">
            ...
            {cartItems.length === 0 ? (
                <div className="notification is-light">Your cart is empty</div>
            ) : (
                <>
